...
public class DialogPais extends javax.swing.JDialog {
    ...
    private void carregaTable(){
        tablePais.setModel(new MyTableModel(
                Pais.class, 
                dao.getAll(), 
                tablePais));
    }
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(textNome, javax.swing.GroupLayout.DEFAULT_SIZE, 273, Short.MAX_VALUE))
    ...
    private void tablePaisMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablePaisMouseClicked
        ...
        if (evt.getClickCount()==2){
            int codigo = 
            Integer.parseInt(
                    tablePais.getValueAt(tablePais.getSelectedRow(), 0)+"");
            Pais pais = dao.get(Pais.class, codigo);
    ...
    private void buttonRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonRemoverActionPerformed
        ...
        try{
            Pais pais = dao.get(Pais.class,Integer.parseInt(textId.getText()));
            dao.remove(pais);;
            this.iniciaComponentes();
            this.carregaTable();
        }catch(Exception ex){
